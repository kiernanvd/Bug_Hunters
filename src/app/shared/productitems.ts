...
export const ProductItems: ProductModel[] = [
  {
    ...
    imgSrc: './assets/img/Mantises.jpg',
    rating: 5,
    reviews: [
      {
      name: 'Jimmy John',
    ...
    imgSrc: './assets/img/Cockroaches.jpg',
    rating: 4,
    reviews: [
      {
      name: 'Mike Tyson',
    ...
    imgSrc: './assets/img/Millipedes.jpg',
    rating: 5,
    reviews: [
      {
      name: 'Johnny Rocket',
    ...
    imgSrc: './assets/img/Pill_Bugs.jpg',
    rating: 3,
    reviews: [
      {
      name: 'Barack Obama',
    ...
    imgSrc: './assets/img/Centipedes.jpg',
    rating: 4,
    reviews: [
      {
      name: 'Marcus Grant',
    ...
    imgSrc: './assets/img/Tarantulas.jpg',
    rating: 5,
    reviews: [
      {
      name: 'Santa Claus',
    ...
    imgSrc: './assets/img/Scorpions.jpg',
    rating: 5,
    reviews: [
      {
    ...
    imgSrc: './assets/img/Butterflies.jpg',
    rating: 4.5,
    reviews: [
      {
      name: 'Matt Damon',
    ...
    name: 'Crickets',
    price: 11.00,
    description: 'Crickets breakdown plant material, renewing soil minerals. They are also an important source of food for other animals.',
    imgSrc: './assets/img/Cricket.jpg',
    rating: 5,
    reviews: [
      {
      name: 'Bruce Lee',
    ...
    name: 'Ants',
    price: 8.00,
    description: 'A single ant can carry 50 times its own bodyweight, and they will even work together to move bigger objects as a group!',
    imgSrc: './assets/img/Ants.jpg',
    rating: 4.5,
    reviews: [
      {
      name: 'George Martin',
